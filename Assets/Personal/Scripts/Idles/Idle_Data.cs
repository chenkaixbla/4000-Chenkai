...
[CreateAssetMenu(fileName = "Idle_Data", menuName = "Game/Idle_Data")]
public class Idle_Data : ScriptableObject
{
    ...
    public void ApplyFinishActions(Idle_Instance idleInstance)
    {
    ...
    public bool AreStartConditionsMet(Idle_Instance idleInstance = null, Job_Instance jobInstance = null)
    {
        EnsureStartConditions();
