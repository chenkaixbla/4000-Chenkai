...
{
    // TODO (Jobs/Idles rework): align shop buy/sell pipelines with Item_Amount-driven idle economy balancing.
    [Title("Dependencies")]
    ...
    [FormerlySerializedAs("shopPanelName")]
    public Menu_ViewPanelId shopPanelId = Menu_ViewPanelId.Shop;
    ...
    {
        ShowConfiguredPanel(shopPanelId);
