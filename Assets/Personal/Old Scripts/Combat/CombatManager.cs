...
{
    // TODO (Jobs/Idles rework): align combat reward/consumption flows with Item_Amount-driven idle economy.
    ...
    [FormerlySerializedAs("combatPanelName")]
    public Menu_ViewPanelId combatPanelId = Menu_ViewPanelId.Combat;
    ...
    {
        ShowConfiguredPanel(combatPanelId);
