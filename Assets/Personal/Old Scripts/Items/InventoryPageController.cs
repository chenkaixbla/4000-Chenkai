...
{
    // TODO (Jobs/Idles rework): expose Item_Amount-based crafting/processing cost previews in inventory UI.
    [Title("Dependencies")]
    ...
    [FormerlySerializedAs("inventoryPanelName")]
    public Menu_ViewPanelId inventoryPanelId = Menu_ViewPanelId.Inventory;
    [FormerlySerializedAs("detailPanelName")]
    public Menu_ViewPanelId detailPanelId = Menu_ViewPanelId.Inventory;
    ...
    public void ShowInventoryPage()
    {
        ...
        ShowConfiguredPanel(inventoryPanelId);
        itemDetailPage?.Clear();
        UpdateActionButtons();
    }
    ...
    public void ShowDetailPage(ItemsData itemData)
    {
        ...
        ShowConfiguredPanel(detailPanelId != Menu_ViewPanelId.None ? detailPanelId : inventoryPanelId);
    ...
    void ShowConfiguredPanel(Menu_ViewPanelId panelId)
    {
        if (panelId == Menu_ViewPanelId.None)
        {
            return;
        }
        ...
        if (menuViewManager == null)
        {
            LogVerboseWarning($"Cannot show panel '{panelId}' because {nameof(Menu_MainViewManager)} is missing.");
            return;
        }

        menuViewManager.ShowPanel(panelId);
    }
}
